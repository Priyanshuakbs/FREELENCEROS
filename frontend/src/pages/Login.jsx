  ...
  return (
    <AnimatedPage className="auth-page">
      ...
      <div className="auth-card relative z-10">
        ...
        <h1 className="mb-1 text-2xl font-black tracking-tight" style={{ color: 'var(--text)' }}>Welcome Back</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="mb-2 flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-xs font-medium text-indigo-400 transition hover:text-indigo-300">Forgot?</Link>
            </div>
            <input
              type="password"
              placeholder="••••••••"
        ...
        <p className="mt-8 text-center text-sm font-medium" style={{ color: 'var(--text-subtle)' }}>
          New here?{' '}
          <Link to="/register" className="font-semibold text-indigo-400 transition hover:text-indigo-300">Create account</Link>
        </p>
      </div>
    </AnimatedPage>
  )
